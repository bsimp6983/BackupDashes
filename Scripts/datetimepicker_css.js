...
var WeekHeadColor="#f3cc4d";
var SundayColor="#f3cc4d";
var SaturdayColor="#f3cc4d";
var WeekDayColor="#f3cc4d";
var FontColor="blue";
...
function RenderCssCal(bNewCal) {
	...
	if (ThemeBg==""){CalBgColor="bgcolor='#f3cc4d'"}
	vCalHeader="<table "+CalBgColor+" background='"+ThemeBg+"' bgcolor='red' border=1 cellpadding=1 cellspacing=1 width='200px' valign='top'>\n";
	...
	if (winCal == undefined) {
       ...
       with (span.style) {position = "absolute"; left = (xpos+8)+'px'; top = (ypos-8)+'px'; width = CalWidth+'px'; border = "solid 2pt " + SpanBorderColor; padding = "0pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 999;}
