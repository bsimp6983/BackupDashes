 ...
 * Demo: http://www.jtricks.com/javascript/navigation/floating/confined_demo.html
 */
var floatingMenu =
{
...
floatingMenu.move = function (item)
{
    ...
    {
        item.menu.style.left = (isNaN(item.nextX) ? 0 : item.nextX) + 'px';
        item.menu.style.right = '';
    }

    if (!item.prohibitYMovement) {
        item.menu.style.top = (isNaN(item.nextY) ? 0 : item.nextY) + 'px';
