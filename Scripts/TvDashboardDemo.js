...
$(document).ready(function() {
    ...
    $('#enddate').val((new Date()).format('MM/dd/yyyy'));
    ...
    $('#TI_Top5DowntimeEvents_Comments input[type="button"].xls').click(function(){
        window.open("ExportXLS.aspx?op=md_Top5DowntimeEvents_Comments&startdate=" + UrlEncode(_dataRange.startDate()) + "&enddate=" + UrlEncode(_dataRange.endDate()) + "&level1=" + UrlEncode(_secondReportConfig.level1) + "&level3=" + UrlEncode(_secondReportConfig.level3) + "&level3_id=" + _secondReportConfig.levelid);
    });
    */
    ...
    $('#Top5OccuringEvents_Comments input[type="button"].xls').click(function(){
        window.open("ExportXLS.aspx?op=md_Top5DowntimeEvents_Comments&startdate=" + UrlEncode(_dataRange.startDate()) + "&enddate=" + UrlEncode(_dataRange.endDate()) + "&level1=" + UrlEncode(_thirdReportConfig.level1) + "&level3=" + UrlEncode(_thirdReportConfig.level3) + "&level3_id=" + _thirdReportConfig.levelid);
    });
    ...
    $('#TI_HistoricalDetail input[type="button"].xls').click(function(){
        window.open("ExportXLS.aspx?op=md_Events&startdate=" + UrlEncode(_dataRange.startDate()) + "&enddate=" + UrlEncode(_dataRange.endDate()));
    });
...
function getTotalDowntime(startdate, enddate, line) {
 $.post("TvDashboardDemo.aspx", "op=TotalDowntime&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&line=" + line, function(data) {
    $('#Total-Downtime label:first').text(data);
 });
}

function LossBuckets(startdate, enddate, line) {
    var width = 616, height = 171;
    
    $.post("TvDashboardDemo.aspx", "op=LossBuckets&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&width=" + width + "&height=" + height + "&line=" + line, function(data) {
...
function Top5DowntimeEvents(startdate, enddate,level1, line) {
    var width = 303, height = 193;
    $.post("TvDashboardDemo.aspx", "op=Top5DowntimeEvents&isHome=true&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&width=" + width + "&height=" + height + "&line=" + line, function(data) {
...
function Top5OccuringEvents(startdate, enddate, level1) {
    ...
    $.post("TvDashboardDemo.aspx", "op=Top5OccuringEvents&isHome=true&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&width=" + width + "&height=" + height, function(data) {
...
function DowntimeActualVsGoal(startdate, enddate, level1,isEvents,goal, type, line) {
    var width = 615, height = 188;
    $.post("TvDashboardDemo.aspx", "op=DowntimeActualVsGoal&isHome=true&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&goal=" + goal + "&type=" + UrlEncode(type.toString()) + "&isEvents=" + isEvents + "&width=" + width + "&height=" + height + "&line=" + line, function(data) {
             var vChart =null;
...
function GetEventRows(startdate,enddate,level1, line)
{
    var tb=$('#home-events-grid');
     var width = 450, height = 300;
    $.post("TvDashboardDemo.aspx", "op=GetEventRows&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1)+ "&width=" + width + "&height=" + height + "&line=" + line, function(data) {
...
function Top5DowntimeEvents_LossBuckets(startdate, enddate) {
    ...
    $.post("TvDashboardDemo.aspx", "op=LossBuckets&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&width=" + width + "&height=" + height, function(data) {
             var vChart =null;
...
function Top5DowntimeEvents_Top5DowntimeEvents(startdate, enddate, level1) {
    var width = 900, height = 300;
    $.post("TvDashboardDemo.aspx", "op=Top5DowntimeEvents_Top5DowntimeEvents&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&width=" + width + "&height=" + height, function(data) {
...
function Top5DowntimeEvents_DowntimeActualVsGoal(startdate, enddate, level1, goal,type,levelid,level3) {
    var width = 900, height = 300;
    $.post("TvDashboardDemo.aspx", "op=Top5DowntimeEvents_DowntimeActualVsGoal&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&type=" + UrlEncode(type) + "&level1=" + UrlEncode(level1) + "&level3=" + UrlEncode(level3) + "&level3_id=" + levelid + "&goal=" + goal + "&width=" + width + "&height=" + height, function(data) {
...
function Top5DowntimeEvents_Comments(startdate, enddate, level1, levelid, level3, line) {
    ...
    $.post("TvDashboardDemo.aspx", "op=Top5DowntimeEvents_Comments&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&level3=" + UrlEncode(level3) + "&level3_id=" + levelid + "&line=" + line, function (d) {
        if (d) {
...
function Top5OccuringEvents_LossBuckets(startdate, enddate) {
    var width = 900, height = 300;
    $.post("TvDashboardDemo.aspx", "op=LossBuckets_Occuring&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&width=" + width + "&height=" + height, function(data) {
         var vChart =null;
...
function Top5OccuringEvents_Top5OccuringEvents(startdate, enddate, level1) {
    var width = 900, height = 300;
    $.post("TvDashboardDemo.aspx", "op=Top5OccuringEvents_Top5OccuringEvents&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&width=" + width + "&height=" + height, function(data) {
         var vChart =null;
...
function Top5OccuringEvents_OccuringActualVsGoal(startdate, enddate, level1, goal,type,levelid,level3) {
    var width = 900, height = 300;
    $.post("TvDashboardDemo.aspx", "op=Top5OccuringEvents_OccuringActualVsGoal&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&type=" + UrlEncode(type) + "&level1=" + UrlEncode(level1) + "&level3=" + UrlEncode(level3) + "&level3_id=" + levelid + "&goal=" + goal + "&width=" + width + "&height=" + height, function(data) {
        var vChart =null;
...
function Top5OccuringEvents_Comments(startdate, enddate, level1, levelid, level3) {
    ...
    $.post("TvDashboardDemo.aspx", "op=Top5OccuringEvents_Comments&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&level3=" + UrlEncode(level3) + "&level3_id=" + levelid, function(data) {
        if (data) {
...
function HistoricalDetail_Top5DowntimeEvents(startdate, enddate,level1) {
    var width = 450, height = 250;
    $.post("TvDashboardDemo.aspx", "op=Top5DowntimeEvents&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&width=" + width + "&height=" + height, function(data) {
        var vChart=null;
...
function HistoricalDetail_Top5OccuringEvents(startdate, enddate, level1) {
    var width = 450, height = 250;
    $.post("TvDashboardDemo.aspx", "op=Top5OccuringEvents&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&width=" + width + "&height=" + height, function(data) {
        var vChart=null;
...
function HistoricalDetail_DowntimeActualVsGoal(startdate, enddate, level1,isEvents,goal, type) {
    var width = 900, height = 300;
    $.post("TvDashboardDemo.aspx", "op=DowntimeActualVsGoal&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&goal=" + goal + "&type=" + UrlEncode(type.toString()) + "&isEvents=" + isEvents + "&width=" + width + "&height=" + height, function(data) {
       var vChart=null;
...
function HistoricalDetail_DowntimeHistory(startdate, enddate, levelid,type) {
    ...
    $.post("TvDashboardDemo.aspx", "op=HistoricalDetail_DowntimeHistory&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate)+ "&level3=" + UrlEncode(_fourReportConfig.level3) + "&level3_id=" + levelid + "&width=" + width + "&height=" + height+"&type="+type, function(data) {
      var vChart=null;
...
function HistoricalDetail_OccurrenceHistory(startdate, enddate, levelid,type) {
    var width = 450, height = 400;
    $.post("TvDashboardDemo.aspx", "op=HistoricalDetail_OccurrenceHistory&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate)+ "&level3=" + UrlEncode(_fourReportConfig.level3_1) + "&level3_id=" + levelid + "&width=" + width + "&height=" + height+"&type="+type, function(data) {
      var vChart=null;
...
function GetRedLines() {
	...
	$.post("TvDashboardDemo.aspx", "op=RedLineList", function(data) {
		if (data) {
...
function SaveEdit(id,sender) {
	...
	$.post("TvDashboardDemo.aspx", "op=updateredline&startDate=" + UrlEncode(startTime) + "&endDate=" + UrlEncode(endTime) + "&Downtime=" + Downtime+ "&Occuring=" + Occuring + "&id=" + id, function(data) {
		if (data == "1") {
...
function SaveAdd(sender) {
	...
	$.post("TvDashboardDemo.aspx", "op=addredline&startDate=" + UrlEncode(startTime) + "&endDate=" + UrlEncode(endTime) + "&Downtime=" + Downtime+ "&Occuring=" + Occuring, function(data) {
		if (data == "1") {
...
function Delete(id) {
	...
	$.post("TvDashboardDemo.aspx", "op=deleteredline&id=" + id, function(data) {
		if (data == "1") {
...
{
    var width = 450, height = 250;
    $.post("TvDashboardDemo.aspx", "op=Hidden_top5downtime&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&width=" + width + "&height=" + height, function(data) {
...
function Hidden_top5occuring(startdate, enddate, level1, line) {
    if (line == undefined)
        line = "all";

    var width = 303, height = 193;
    $.post("TvDashboardDemo.aspx", "op=Hidden_top5occuring&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&width=" + width + "&height=" + height + "&line=" + line, function(data) {
...
function Hidden_DowntimeActualVsGoal(startdate, enddate, level1,isEvents,goal, type) {
    var width = 450, height = 300;
    $.post("TvDashboardDemo.aspx", "op=Hidden_DowntimeActualVsGoal&isHome=true&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1) + "&goal=" + goal + "&type=" + UrlEncode(type.toString()) + "&isEvents=" + isEvents + "&width=" + width + "&height=" + height, function(data) {
             var vChart =null;
...
function Hidden_GetEventRows(startdate,enddate,level1)
{
    var tb=$('#hidden-events-grid');
     var width = 450, height = 300;
    $.post("TvDashboardDemo.aspx", "op=Hidden_GetEventRows&startdate=" + UrlEncode(startdate) + "&enddate=" + UrlEncode(enddate) + "&level1=" + UrlEncode(level1)+ "&width=" + width + "&height=" + height, function(data) {
       tb.find('tbody tr').remove();
       $(data).each(function(i,item){
            tb.find('tbody').append('<tr class="data">'+
                            '<td>'+item.Minutes+'</td>'+
