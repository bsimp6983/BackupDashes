...
namespace DCSDemoData
{
    ...
    public class CommentRow
    {
        ...
        public string EventStartTimeStr
        {
            get
            {
                return this.EventStart.Value.ToString(@"MM\/dd\/yyyy");
            }
        }
        ...
        public string EventStopTimeStr
        {
            get
            {
                return this.EventStop.Value.ToString(@"MM\/dd\/yyyy");
            }
        }
    ...
    public class GoalReportRow
    {
        ...
        {
            this.Downtimes = new GoalDowntimeRow();
            this.Occurences = new GoalOccurencesRow();
        }
    }
    ...
    public class ClientGoalRow
    {
        ...
        public string StartTimeStr { get { return this.StartTime.ToString(@"MM\/dd\/yyyy"); } }
        public string EndTimeStr { get { return this.EndTime.ToString(@"MM\/dd\/yyyy"); } }
    }
    #endregion
}
