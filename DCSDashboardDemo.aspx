<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DCSDashboardDemo.aspx.cs" Inherits="DowntimeCollection_Demo.DCSDashboardDemo" %>
...
<head runat="server">
    ...
    #btnGo{margin-left:-85px;margin-top:3px; float: left;}
            ...
            <asp:Panel ID="divKPIS" runat="server">
                ...
                <div style="float: left; width: 250px;margin-top: -10px;margin-left: 50px;font-size: 18px;">
                    <ul style=" list-style: none;">
                        <li>
                            Total Downtime: <label id="totalDowntime">--</label>
                        </li>
                        <li>
                            MTBF: <label id="mtbf">--</label>
                        </li>
                        <li>
                            RF: <label id="rf">--</label>
                        </li>
                        <li>
    ...
    <div id="fake"> 
        ...
        <div id="TI_Home" class="TabItem">
            ...
            <div id="DowntimeActualVsGoal_rows">
                <input type="radio" name="radEvents" id="radShowBasic" checked="checked" /> Basic
                <input type="radio" name="radEvents" id="radShowAdvance" /> Advance
                Filter by Cumulative: <input type="text" id="txtEventSearch" />
...
<div id="dock">
    <div class="container">
        ...
        <a href="#" class="LineEfficiency" tabitem="TI_LineEfficiency"></a>
