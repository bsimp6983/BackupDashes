...
<body>
	...
	<div id="main">
		<div class="columnDiv">
			<ul id="NEEDLE PUNCH" class="line">
				<li class="columnHeader"><b>NEEDLE PUNCH</b></li>
				<li class="green_border" id="NP_1"><a href="DCSDemo.aspx?line=NP_1" target="_blank">
					<b>NP1</b><br /></a>
					<div class="percent">--%</div>  <div class="time">--:--:--</div>
					<div class="buttons">
						<a href="DCSDemo.aspx?line=NP_1" target="_blank">OI</a>
						<a href="http://dashboard.thrivemes.com/downtime/snapshot?line=NP_1" target="_blank">DB</a>
						<a href="DCSDemoReasonCodes.aspx?line=NP_1" target="_blank">RC</a>
					</div>
				</li>
				<li class="green_border" id="NP_2"><a href="DCSDemo.aspx?line=NP_2" target="_blank">
					<b>NP2</b><br /></a>
					<div class="percent">--%</div>  <div class="time">--:--:--</div>
					<div class="buttons">
						<a href="DCSDemo.aspx?line=NP_2" target="_blank">OI</a>
						<a href="http://dashboard.thrivemes.com/downtime/snapshot?line=NP_2" target="_blank">DB</a>
						<a href="DCSDemoReasonCodes.aspx?line=NP_2" target="_blank">RC</a>
					</div>
				</li>
			</ul>
		</div>
